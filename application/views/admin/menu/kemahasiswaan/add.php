...
<div class="box">
    <div class="box-header">
        <div class="col-md-12">
            <h2 class="page-header">Tambah kemahasiswaan</h2>
        </div>
    </div>
    ...
    <div class="box-body">
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-body">
                    <?php echo form_open('admin/menu/kemahasiswaan/tambah','role="form" enctype="multipart/form-data" class="form-horizontal"'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-8 card-body">
                            <div >
                                ...
                                <input type="text" placeholder="Judul kemahasiswaan" name="nama_sub_menu" value="<?php echo $this->input->post('nama_sub_menu'); ?>" class="form-control" required>
                            </div>
