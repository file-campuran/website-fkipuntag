...
class Carousel_model extends CI_Model
{
    ...
    function detail_data($id_carousel)
    {   $this->db->select('
        carousel.*,
        ');
        $query =  $this->db->get_where($this->table, array('id_carousel' => $id_carousel));
        return $query->row();
    }
    ...
    function update_data($data, $id_carousel)
    {
    ...
    {
        $this->db->where('id_carousel', $id_data);
